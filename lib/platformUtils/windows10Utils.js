...
var serviceEndpoint = 'http://cloudappx-pre.azurewebsites.net';
  ...
  output.on('close', function () {
    ...
    var req = request.post(options, function (err, resp, body) {
      ...
      if (resp.statusCode != 200) {
        return callback && callback(new Error('Failed to create the package. The CloudAppX service returned an error: ' + resp.statusCode + ' - ' + resp.statusMessage));
      }
