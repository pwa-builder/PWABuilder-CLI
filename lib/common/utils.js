...
// This function sanitizes the name to only allow the following only allow the following: ([A-Za-z][A-Za-z0-9]*)(\.[A-Za-z][A-Za-z0-9]*)*
function sanitizeName(name) {
  ...
  do {
    ...
    // If the bane starts with a dot, remove the dot
    ...
    // if the bane ends with a dot, remove the dot
    sanitizedName = sanitizedName.replace(/\.$/, ''); 
  }
