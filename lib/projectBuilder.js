    ...
    manifestTools.writeToFile(w3cManifestInfo, manifestFilePath, function (err) {
      ...
      exec(cmdLine, function (err, stdout, stderr) {
        ...
        platforms.forEach(function (platform) {
          if (!pendingTasks) {
            pendingTasks = createCordovaAppForPlatform(generatedAppDir, platformDir, build, platform);
          } else {
            pendingTasks = pendingTasks.fail(function (err) { somePendingTaskFailed = true; })
